...
public class gmailController {
    ...
    @GetMapping("apis/apiGmail")
    public String appigmail() {
        return "apis/apiGmail";
    }

    @GetMapping("apis/gmailLabels")
    public String getGmailLabels() throws Exception {
